...
public class InfoEditText extends ConstraintLayout {
    ...
    public InfoEditText(Context context, @Nullable AttributeSet attrs) {
        ...
        this.editable = a.getBoolean(R.styleable.InfoEditText_fieldEditable,false);
        a.recycle();
    ...
    public void focusableEditText(boolean value){
        edtValue.setFocusable(value);
    }

    private void initializeView(Context context) {
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.item_user_info, this);
    }
}
